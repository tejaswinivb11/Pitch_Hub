  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className="text-center my-5">Teaching</h2>
        <div className="row">
          {faculties
           .filter((nonteaching)=>nonteaching.type === "Teaching")
          .map(user => (
            <div key={user.id} className="col-md-4 mb-4">
           <Card className="text-center shadow" style={{ maxWidth: "250px" }}>
